...
public class ProviderService {
    ...
    public ProviderService(@Qualifier("ProviderRepository")ProviderRepository providerRepository, 
                            @Qualifier("ForwardRepository") ForwardRepository forwardRepository) {
