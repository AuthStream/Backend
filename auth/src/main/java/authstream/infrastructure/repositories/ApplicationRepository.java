...
public interface ApplicationRepository extends JpaRepository<Application, String> {
        ...
        String addAppQuery = "INSERT INTO applications (application_id, name, provider_id, admin_id, created_at, updated_at) "
                        +
                        "VALUES (:id, :name, :providerId, :adminId, :createdAt, :updatedAt)";
        ...
        @Query(value = updateAppByIdQuery, nativeQuery = true)
        int updateApplication(@Param("id") String id, @Param("newName") String newName,
                        @Param("newProviderId") String newProviderId, @Param("newAdminId") String newAdminId,
        ...
        @Transactional
        @Query(value = addAppQuery, nativeQuery = true)
        int addApplication(@Param("id") String id, @Param("name") String name, @Param("providerId") String providerId,
                        @Param("adminId") String adminId, @Param("createdAt") LocalDateTime createdAt,
