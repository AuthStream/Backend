...
public interface AuthTableConfigRepository extends JpaRepository<AuthTableConfig, UUID> {
    ...
    String addConfigQuery = "INSERT INTO auth_table_config (id, user_table, password_attribute, " +
            "hashing_type, salt, hash_config, created_at, updated_at) " +
            "VALUES (:id, :userTable, :passwordAttribute, :hashingType, :salt, cast(:hashConfig as jsonb), " +
            ":createdAt, :updatedAt)";
