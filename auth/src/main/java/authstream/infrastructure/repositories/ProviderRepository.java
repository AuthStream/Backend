...
public interface ProviderRepository extends JpaRepository<Provider, String> {
    ...
    @Transactional
    @Query(value = addProviderQuery, nativeQuery = true)
    int addProvider(@Param("id") String id, @Param("name") String name, @Param("applicationId") String applicationId,
            @Param("methodId") String methodId, @Param("type") String type,
            @Param("createdAt") LocalDateTime createdAt, @Param("updatedAt") LocalDateTime updatedAt);
}